...
let g:colors_name = 'hancktheme'

" General colors"{{{
hi ColorColumn ctermfg=NONE ctermbg=97 cterm=NONE guifg=NONE guibg=#4c2b8f gui=NONE
hi Conceal ctermfg=119 ctermbg=NONE cterm=NONE guifg=#43a283 guibg=NONE gui=NONE
hi Cursor ctermfg=16 ctermbg=119 cterm=NONE guifg=#000000 guibg=NONE gui=NONE
hi CursorIM ctermfg=NONE ctermbg=168 cterm=NONE guifg=NONE guibg=#a62163 gui=NONE
...
hi Directory ctermfg=156 ctermbg=NONE cterm=NONE guifg=#43a283 guibg=NONE gui=NONE
hi DiffAdd ctermfg=16 ctermbg=156 cterm=NONE guifg=#000000 guibg=#21a66f gui=NONE
hi DiffChange ctermfg=16 ctermbg=175 cterm=NONE guifg=#000000 guibg=#a63275 gui=NONE
hi DiffDelete ctermfg=156 ctermbg=NONE cterm=NONE guifg=#21a66f guibg=NONE gui=NONE
hi DiffText ctermfg=16 ctermbg=168 cterm=bold guifg=#000000 guibg=#a63275 gui=bold
hi EndOfBuffer ctermfg=119 ctermbg=NONE cterm=NONE guifg=#21a66f guibg=NONE gui=NONE
hi ErrorMsg ctermfg=168 ctermbg=NONE cterm=bold guifg=#a63275 guibg=#2b1211 gui=bold
hi VertSplit ctermfg=97 ctermbg=NONE cterm=NONE guifg=#5b42a6 guibg=NONE gui=NONE
hi Folded ctermfg=97 ctermbg=235 cterm=bold guifg=#4c2b8f guibg=#2c2d2f gui=bold
hi FoldColumn ctermfg=97 ctermbg=NONE cterm=bold guifg=#4c2b8f guibg=NONE gui=bold
hi SignColumn ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi IncSearch ctermfg=16 ctermbg=119 cterm=bold guifg=#000000 guibg=#21a66f gui=bold
...
hi ModeMsg ctermfg=119 ctermbg=NONE cterm=bold guifg=#43a283 guibg=NONE gui=bold
hi MoreMsg ctermfg=119 ctermbg=NONE cterm=bold guifg=#43a283 guibg=NONE gui=bold
...
hi Pmenu ctermfg=119 ctermbg=16 cterm=NONE guifg=#43a283 guibg=#2c2d2f gui=NONE
hi PmenuSel ctermfg=16 ctermbg=119 cterm=NONE guifg=#000000 guibg=#5b42a6 gui=NONE
hi PmenuSbar ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=#2c2a35 gui=NONE
hi PmenuThumb ctermfg=NONE ctermbg=119 cterm=NONE guifg=NONE guibg=#5b42a6 gui=NONE
hi Question ctermfg=119 ctermbg=NONE cterm=underline guifg=#5b42a6 guibg=NONE gui=underline
hi Search ctermfg=16 ctermbg=75 cterm=bold guifg=#000000 guibg=#5b42a6 gui=bold
hi SpecialKey ctermfg=97 ctermbg=NONE cterm=NONE guifg=#5b42a6 guibg=NONE gui=NONE
...
hi StatusLine ctermfg=63 ctermbg=16 cterm=NONE guifg=#87FF5F guibg=#292929 gui=NONE
hi StatusLineNC ctermfg=240 ctermbg=16 cterm=NONE guifg=#5b42a6 guibg=#292929 gui=NONE
...
hi Visual ctermfg=NONE ctermbg=97 cterm=bold guifg=NONE guibg=#5b42a6 gui=bold
hi WarningMsg ctermfg=226 ctermbg=NONE cterm=bold guifg=#a69b21 guibg=#2b2a11 gui=bold
hi WildMenu ctermfg=119 ctermbg=NONE cterm=NONE guifg=#a63275 guibg=NONE gui=NONE
"}}}
" Syntax highlighting"{{{
hi Comment ctermfg=102 ctermbg=NONE cterm=NONE guifg=#3b4252 guibg=NONE gui=NONE
